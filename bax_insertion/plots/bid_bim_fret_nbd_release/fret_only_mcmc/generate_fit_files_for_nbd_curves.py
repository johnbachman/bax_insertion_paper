...
args = {
    'model': {
        'multiconf_fret': [2, 3], # 2, 3, 4
    'model_observable': ['FRET'],
...
basedir = sys.argv[1]
output_target_pattern = 'pt_data2_fretonly_%s_NBD_%s_r%s'
...
# list of .mcmc files
deps_filename = os.path.join(basedir, 'pt_data2_fretonly.deps.txt')
target_name = 'pt_data2_fretonly'
